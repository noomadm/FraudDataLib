...
public class PatternAnalysis{
	...
	private String a_t_m_trans_date;
	private String a_t_m_message_sequence;
	private Integer cost_center;
	private String check_number;
	private String effective_date;
	private String g_l_set_code;
	private Integer reversed_e_c_indicator;
	...
	private String form_ac_province;
	private String to_cust_no;
	private String to_cust_name;
	private String to_card_name;
	private String to_ac_no;
	private String to_ac_name;
	private String to_branch_code;
	private String to_branch_name;
	private String to_bank_code;
	private String to_bank_name;
	private String to_ac_province;
	private String override_id;
	private String trxn_branch_name;
	private String trxn_branch_province;
	private String term_id;
	private String term_bank;
	private String term_city;
	private String term_province;
	private String term_country;
	...
	private String plus_post_con_code;
	private String trxn_mode;
	private String trxn_channel;
	
	
	public String getFrom_cust_no() {
		return from_cust_no;
	}
	public void setFrom_cust_no(String from_cust_no) {
	...
	public String getFrom_branch_name() {
		return from_branch_name;
	}
	public void setFrom_branch_name(String from_branch_name) {
		this.from_branch_name = from_branch_name;
	}
	public String getFrom_bank_code() {
		return from_bank_code;
	}
	public void setFrom_bank_code(String from_bank_code) {
	...
	public String getForm_ac_province() {
		return form_ac_province;
	}
	public void setForm_ac_province(String form_ac_province) {
		this.form_ac_province = form_ac_province;
	}
	public String getTo_cust_no() {
		return to_cust_no;
	}
	public void setTo_cust_no(String to_cust_no) {
		this.to_cust_no = to_cust_no;
	}
	public String getTo_cust_name() {
		return to_cust_name;
	}
	public void setTo_cust_name(String to_cust_name) {
		this.to_cust_name = to_cust_name;
	}
	public String getTo_card_name() {
		return to_card_name;
	}
	public void setTo_card_name(String to_card_name) {
		this.to_card_name = to_card_name;
	}
	public String getTo_ac_name() {
		return to_ac_name;
	}
	public void setTo_ac_name(String to_ac_name) {
		this.to_ac_name = to_ac_name;
	}
	...
	public void setTo_branch_name(String to_branch_name) {
		this.to_branch_name = to_branch_name;
	}
	...
	public String getTo_ac_province() {
		return to_ac_province;
	}
	public void setTo_ac_province(String to_ac_province) {
		this.to_ac_province = to_ac_province;
	}
	public String getOverride_id() {
		return override_id;
	}
	public void setOverride_id(String override_id) {
	...
	public String getTrxn_branch_name() {
		return trxn_branch_name;
	}
	public void setTrxn_branch_name(String trxn_branch_name) {
		this.trxn_branch_name = trxn_branch_name;
	}
	public String getTrxn_branch_province() {
		return trxn_branch_province;
	}
	public void setTrxn_branch_province(String trxn_branch_province) {
		this.trxn_branch_province = trxn_branch_province;
	}
	...
	public String getTerm_city() {
		return term_city;
	}
	public void setTerm_city(String term_city) {
		this.term_city = term_city;
	}
	public String getTerm_province() {
		return term_province;
	}
	public void setTerm_province(String term_province) {
		this.term_province = term_province;
	}
	public String getTerm_country() {
		return term_country;
	}
	public void setTerm_country(String term_country) {
		this.term_country = term_country;
	}
	...
	public String getPlus_post_con_code() {
		return plus_post_con_code;
	}
	public void setPlus_post_con_code(String plus_post_con_code) {
		this.plus_post_con_code = plus_post_con_code;
	}
	public String getTrxn_mode() {
		return trxn_mode;
	}
	public void setTrxn_mode(String trxn_mode) {
		this.trxn_mode = trxn_mode;
	}
	public String getTrxn_channel() {
		return trxn_channel;
	}
	public void setTrxn_channel(String trxn_channel) {
		this.trxn_channel = trxn_channel;
	}
	...
	public String getA_t_m_trans_date() {
		return a_t_m_trans_date;
	}
	public void setA_t_m_trans_date(String a_t_m_trans_date) {
		this.a_t_m_trans_date = a_t_m_trans_date;
	}
	public String getA_t_m_message_sequence() {
		return a_t_m_message_sequence;
	}
	public void setA_t_m_message_sequence(String a_t_m_message_sequence) {
		this.a_t_m_message_sequence = a_t_m_message_sequence;
	}
	...
	public String getG_l_set_code() {
		return g_l_set_code;
	}
	public void setG_l_set_code(String g_l_set_code) {
		this.g_l_set_code = g_l_set_code;
	}
	public Integer getReversed_e_c_indicator() {
		return reversed_e_c_indicator;
	}
	public void setReversed_e_c_indicator(Integer reversed_e_c_indicator) {
		this.reversed_e_c_indicator = reversed_e_c_indicator;
	}
